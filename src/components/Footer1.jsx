        ...
        <div className="block md:hidden">
          ...
          <div className="flex items-center justify-around mt-7" dir="rtl">
            <p className="w-[190px] text-[8px] p-3">
              تمامی حقوق این وبسایت متعلق به سفرکو است و هر گونه کپی برداری
        ...
        <div className="hidden w-full md:flex justify-center max-w-[1200px] container p-auto md:p-10 ">
          ...
          <div className="flex flex-col items-end">
            ...
            <p dir="rtl" className="text-[16px] w-[360px] my-4">
              (<span className="text-[#1BE6E3]">سفرکو</span>) یک پلفترم بزرگ
              شناخت جاذبه های گردشگری است.هدف ما از این کار شناخت تمامی نقاط
              گردشگری ایران و معرفی آن به تمام مردم ایران و حتی جهان است ، تا به
