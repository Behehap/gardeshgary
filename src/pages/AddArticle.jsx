      ...
      <div className="flex md:hidden" dir="rtl">
        ...
        <div className="flex items-start">
          ...
          {/* } */}
             ...
             {/* منوی دوم */}
             {/* {!isFirstMenuOpen && (
            <div className="flex flex-col items-start mb-3 rounded-md h-full w-72 bg-white ">
              <div className="p-4 md:block">
                ...
                <ul className="mt-4 no-underline ">
                  <div className="hover:rounded-md flex my-9  no-underline" onClick={() => toggleActive("write")} >
                  <SiLibreofficewriter  className={`w-10 h-10 text-black bg-white ${isActive === "write" ? 'text-blue-900 ' : ''}`} />
                      <link  to="/AArticle" className="p-2 border-b border-gray-300 text-gray-500 text-[20px]">نوشتن تجربه جدید سفر</link>
                  </div>

                  <div className="hover:bg-[#9DDAF9] hover:rounded-md flex my-9" onClick={() => toggleActive("experience")}>
                  <FaRegCircleCheck  className={`w-10 h-10 text-black  ${isActive === " experience" ? 'text-green-600':''}`}  />
                    <li className=" p-2 border-b border-gray-300 text-gray-500 text-[20px]">تجربیات منتشر شده </li> 
                  </div>

                  <div className="hover:bg-[#9DDAF9] hover:rounded-md flex my-9 " onClick={() => toggleActive("chart")}>
                  <BsBarChartLine  className={`w-10 h-10 text-black  ${isActive === "chart" ? 'text-yellow-500' : ''}`} />
                    <li className=" p-2 border-b border-gray-300 text-gray-500 text-[20px]">امار بازدید مقاله</li>
                  </div>

                  <div className="hover:bg-[#9DDAF9] hover:rounded-md flex my-9" onClick={() => toggleActive("travel")}>
                  <BiSolidHeartCircle className={`w-10 h-10 text-black  ${isActive=== "travel" ? 'text-red-900' : ''}`}/>
                    <li className=" p-2 border-b border-gray-300 text-gray-500 text-[20px]">سفر های پیشنهادی</li>
                  </div>

                  <div className="hover:bg-[#9DDAF9] hover:rounded-md flex my-9" onClick={() => toggleActive("save")}>
                  <BsBookmarks className={`w-10 h-10 text-black  ${isActive === "save" ? 'text-amber-950' : ''}`} />
                    <li className=" p-2 border-b border-gray-300 text-gray-500 text-[20px]">ذخیره مقالات </li>
                  </div>

                  <div className="hover:bg-[#9DDAF9] hover:rounded-md flex my-9" onClick={() => toggleActive("mypoint")}>
                  <CiMedal className={`w-10 h-10 text-black  ${isActive === "mypoint" ? 'text-blue-600' : ''}`} />
